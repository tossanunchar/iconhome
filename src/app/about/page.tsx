        ...
        <div className="flex-1">
          <div className="bg-white border border-gray-200 rounded-sm p-6">
            ...
            <div className="text-sm text-gray-700 leading-relaxed space-y-4">
              ...
              <p>
                เราเปิดให้บริการทุกวัน ตั้งแต่เวลา 08.00 น. - 18.00 น. ที่เลขที่ 46 หมู่ 5 ตำบลขวัญเมือง
                อำเภอเสลภูมิ จังหวัดร้อยเอ็ด สามารถสอบถามข้อมูลเพิ่มเติมได้ที่โทรศัพท์
                096-365-0471, 080-326-6271 หรือ 080-324-3871
              </p>
